                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('laporan-guru') }}"
                            class="ms-1 text-xs md:text-sm font-medium  {{ request()->is('laporan-guru') ? 'text-blue-600' : 'text-gray-700' }} hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                            Laporan Data Guru</a>
            ...
            <div class="border border-gray-300 rounded-sm  mt-4">
                ...
                <div class="bg-gray-100 p-4 mt-2 flex justify-center space-x-4">
                    <a href="{{ route('laporan-guru.viewGuru') }}"
                        class="bg-purple-500 text-white text-[9px] md:text-base font-semibold py-1 px-4 md:px-8 rounded hover:bg-purple-600">Print
                        Preview</a>
                    <a href="{{ route('laporan-guru.downloadGuru') }}"
                        class="bg-yellow-400 text-white text-[9px] md:text-base font-semibold py-1 px-4 md:px-8 rounded hover:bg-yellow-600">Download</a>
                    <a href="{{ route('laporan-guru.download-excel') }}"
                        class="bg-red-600 text-white text-[9px] md:text-base font-semibold py-1  px-4 md:px-8 rounded hover:bg-red-700">Export
                        Excel</a>
                </div>
            </div>
            <form action="{{ route('laporan-guru.viewFilterGuru') }}" method="GET" id="filterForm">
                <div class="border border-gray-300 rounded-sm mt-8">
                    ...
                    <div class="bg-gray-100 p-4 mt-2 flex justify-center space-x-4">
                        ...
                        <button type="submit"
                            class="bg-purple-500 text-white text-[9px] md:text-base font-semibold py-1 px-4 md:px-8 rounded hover:bg-purple-600"
                            onclick="submitForm('preview')">Print
                            Preview</button>
                        <button
                            class="bg-yellow-400 text-white text-[9px] md:text-base font-semibold py-1 px-4 md:px-8 rounded hover:bg-yellow-600"
                            onclick="submitForm('download')">Download</button>
                        <button
                            class="bg-red-600 text-white text-[9px] md:text-base font-semibold py-1 px-4 md:px-8 rounded hover:bg-red-700"

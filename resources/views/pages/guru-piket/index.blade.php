                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('guru-piket') }}"
                            class="ms-1 text-xs md:text-sm font-medium  {{ request()->is('guru-piket') ? 'text-blue-600' : 'text-gray-700' }} hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                            Data Guru Piket</a>
                    ...
                    <tbody id="guru-piket-list">
                        @foreach ($guruPiket as $GP)
                            <tr
                                ...
                                <td class="px-8 py-3 text-center text-sm font-semibold capitalize">
                                    {{ $GP->guru->nama_guru }}
                                </td>
                                    ...
                                    <td class="px-5 py-3 ">
                                        ...
                                        <div class="flex items-center justify-center ">
                                            <a type="button" id="edit-btn"
                                                data-modal-target="edit-guru-piket-{{ $GP->id }}"
                    ...
                    success: function(data) {
                        ...
                        $(document).on("click", "#edit-btn", function() {
                            ...
                            $("#" + modalId).removeClass("hidden").addClass(
                                "flex backdrop-blur-sm bg-opacity-10 drop-shadow-sm"
                            );
                        });

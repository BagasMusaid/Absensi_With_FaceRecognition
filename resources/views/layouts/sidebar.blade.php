                        ...
                        @can('akses-kepala_sekolah')
                            <li>
                                <a href="{{ url('laporan-presensi') }}"
                                    class="flex items-center {{ active_class(['laporan-presensi']) }} w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-14 group  dark:text-white dark:hover:bg-gray-700">Data
                                    Presensi</a>
                            </li>
                            <li>
                                <a href="{{ url('laporan-guru') }}"
                                    class="flex items-center w-full {{ active_class(['laporan-guru']) }} p-2 text-gray-600 transition duration-75 rounded-lg pl-14 group  dark:text-white dark:hover:bg-gray-700">Data
                                    Guru</a>
                            </li>
                            <li>
                                <a href="{{ url('laporan-mata-pelajaran') }}"
                                    class="flex items-center w-full {{ active_class(['laporan-mata-pelajaran']) }} p-2 text-gray-600 transition duration-75 rounded-lg pl-14 group  dark:text-white dark:hover:bg-gray-700">Data
                                    Mapel</a>
                            </li>
                        @endcan
                        @can('akses-laporan')

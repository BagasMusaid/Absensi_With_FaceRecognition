                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('laporan-presensi') }}"
                            class="ms-1 text-xs md:text-sm font-medium  {{ request()->is('laporan-presensi') ? 'text-blue-600' : 'text-gray-700' }} hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">

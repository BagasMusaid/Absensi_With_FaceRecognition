...
<table
    ...
    <thead>
        <tr style="background-color: #e2e8f0;border-bottom: 1px solid #ddd; ">
            ...
            <th style="padding: 12px 8px; text-align: center; font-size: 13px;">Jenis Kelamin</th>
            <th style="padding: 12px 8px; text-align: center;  font-size: 13px;">Kelas
            </th>
            <th style="padding: 12px 8px; text-align: center; font-size: 13px;">Tanggal</th>
            <th style="padding: 12px 8px; text-align: center; font-size: 13px;">Status
            </th>
        </tr>
    </thead>
    <tbody>

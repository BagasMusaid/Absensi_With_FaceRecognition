    ...
    <div class="p-4 sm:ml-64 ">
        ...
        <div class="p-4 bg-white dark:border-gray-700 mt-5 ">
            <div class="flex items-start mx-5 md:mx-10 border-b border-purple-300">
                <a href="{{ url('akun') }}"
                    class="border py-2 px-6 text-purple-700 @if (request()->is('akun')) bg-purple-700 text-white @endif">Profile</a>
                <a href="" class="border py-2 px-4">Password</a>
            </div>
            <div class="md:flex mx-5 items-center justify-between ">
                <div class="p-5 mt-10">
                    <div class="relative justify-center w-60 h-60">
                        <img src="{{ Auth::user()->poto ? url(Storage::url(Auth::user()->poto)) : asset('asset/images/profie.jpg') }}"
                            alt="Profile Picture"
                            class="w-full h-full rounded-full object-cover border-2 border-white shadow-lg ml-10 md:ml-0">
                        <div
                ...
                <div class=" w-full md:ml-24 mt-5">
                    <div class="flex flex-row gap-4 justify-between ">
                        <div class="w-full">
                            ...
                            <input type="text" name="nama" id="nama" disabled
                                ...
                                block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 border-gray-300 
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex w-full gap-3">
                                <div class="border border-gray-300 pt-1.5 pb-2 pl-2 rounded-lg w-full bg-gray-50">
                                    <input type="checkbox" name="gender" value="Laki-laki" disabled
                    ...
                    <div class="mt-10">
                        <a href="" class="py-2 px-4 bg-purple-700 rounded-lg text-white font-semibold">Ubah Data</a>
                    </div>
                </div>

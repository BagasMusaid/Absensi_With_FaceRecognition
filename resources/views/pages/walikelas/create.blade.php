<div id="tambah-walikelas" tabindex="-0" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="tambah-walikelas">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" method="post" action="{{ route('walikelas.store') }}">
                    @csrf
                    ...
                    <div>
                        ...
                        <select id="guru_id" name="guru_id"
                            ...
                            <option value="" disabled {{ old('guru_id') ? '' : 'selected' }}>Pilih Nama Wali Kelas
                            </option>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password"
                            class="bg-gray-50 border block {{ $errors->has('password') ? 'border-red-600' : 'border-gray-300' }}  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"

                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('ranking-kehadiran') }}"
                            class="ms-1 text-sm font-medium  {{ request()->is('ranking-kehadiran*') ? 'text-blue-600' : 'text-gray-700' }} hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                            Ranking Kehadiran</a>

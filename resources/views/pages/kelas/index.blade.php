    ...
    <div class="p-4 sm:ml-64">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('kelas') }}"
                            class="ms-1 text-sm font-medium  {{ request()->is('kelas') ? 'text-blue-600' : 'text-gray-700' }} hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                            Data Kelas</a>
        ...
        <div class="p-4 bg-white dark:border-gray-700 mt-5">
            <div
                ...
                <div
                    class="flex cursor-pointer mt-4 md:mt-0 bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg">
                    ...
                    <a data-modal-target="tambah-kelas" data-modal-toggle="tambah-kelas"
                    ...
                    <tbody id="kelas-list">
                        @foreach ($kelas as $ks)
                            <tr
                                ...
                                <td class="px-7 py-3 text-sm font-semibold capitalize text-center">
                                    {{ $ks->tahun_ajaran->tahun_mulai }}/{{ $ks->tahun_ajaran->tahun_selesai }}
                                </td>
                                <td class="px-7 py-3 text-sm font-semibold capitalize text-center">
                                    {{ $ks->catatan ? $ks->catatan : 'Tidak Ada' }}
                                </td>
                                <td class="px-7 py-3 flex items-center justify-center">
                                    <!-- Modal toggle -->
                                    <div>

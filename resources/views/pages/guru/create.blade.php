                ...
                <form class="space-y-6" method="post" action="{{ route('guru.store') }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama"
                            ...
                            placeholder="Masukan Nama Guru" value="{{ old('nama') }}" autocomplete="off">
                        @error('nama')
                    ...
                    <div class="flex flew-row justify-between">
                        <div>
                            ...
                            <input type="text" inputmode="numeric" name="nip" id="nip"
                                ...
                                placeholder="Masukan NIP" value="{{ old('nip') }}" autocomplete="off">
                            @error('nip')
                                <small
                    ...
                    <div class="flex justify-between flex-row">
                        <div>
                            ...
                            <input type="text" inputmode="numeric" name="tlp" id="tlp"
                                ...
                                placeholder="Masukan No Telepone" value="{{ old('tlp') }}" autocomplete="off">
                            @error('tlp')
                                <small
                                    class="mt-1 ml-1 text-[10px] text-red-600 dark:text-red-500">{{ $message }}</small>
                            @enderror
